...
{
    /**
     * @Route("/dashboard", name="restaurant_dashboard_admin")
     */
    ...
    /**
     * @Route("/dashboard/review/{restaurantId}", name="restaurant_review_admin")
     */
    public function restaurantReview(Request $request, $restaurantId){
        ...
        //Nous transmettons les variables pertinentes à notre vue Twig via le render()
        return $this->render('admin/restaurant-review.html.twig', [
            'categories' => $categories,
    ...
    /**
     * @Route("/create", name="restaurant_create_admin")
     */
    public function createRestaurant(Request $request): Response
    {
        ...
        $restaurantForm = $this->createForm(AdminRestaurantType::class, $restaurant);
    ...
    /**
     * @Route("/update/{restaurantId}", name="restaurant_update_admin")
     */
    ...
    /**
     * @Route("/delete/{restaurantId}", name="restaurant_delete_admin")
     */
    ...
    /**
     * @Route("/dish/create/{restaurantId}", name="dish_create_admin")
     */
    public function createDish(Request $request, $restaurantId): Response{
        ...
        if(!$restaurant){
            return $this->redirect($this->generateUrl('restaurant_dashboard_admin'));
        }
        //Si le Restaurant existe, nous nous chargeons de la génération de notre formulaire
        $dish = new Dish;
        $dishForm = $this->createForm(AdminDishType::class, $dish);
        ...
        if($request->isMethod('post') && $dishForm->isValid()){
            ...
            $entityManager->flush();
            return $this->redirect($this->generateUrl('restaurant_review_admin', ['restaurantId' => $restaurantId]));
        }
    ...
    /**
     * @Route("/dish/update/{dishId}", name="dish_update_admin")
     */
    ...
    /**
     * @Route("/dish/delete/{dishId}", name="dish_delete_admin")
     */
    public function deleteDish(Request $request, $dishId = false): Response{
        ...
        $entityManager->flush();
        return $this->redirect($this->generateUrl('restaurant_review_admin', ['restaurantId' => $dish->getRestaurant()->getId()]));
    }
}
